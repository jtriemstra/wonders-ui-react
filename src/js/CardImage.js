class CardImage {
    ...
    static getImage(cardName) {
        ...
        if (cards.length == 0){
            ...
            cards["Alexander"] = "alexander.png";
            cards["Amytis"] = "amytis.png";
            cards["Archimedes"] = "archimedes.png";
            cards["Aristotle"] = "aristotle.png";
            cards["Caesar"] = "caesar.png";
            cards["Cleopatra"] = "cleopatra.png";
            cards["Croesus"] = "croesus.png";
            cards["Euclid"] = "euclid.png";
            cards["Hammurabi"] = "hammurabi.png";
            cards["Hannibal"] = "hannibal.png";
            cards["Hatshepsut"] = "hatshepsut.png";
            cards["Hiram"] = "hiram.png";
            cards["Hypatia"] = "hypatia.png";
            cards["Justinian"] = "justinian.png";
            cards["Leonidas"] = "leonidas.png";
            cards["Maecenas"] = "maecenas.png";
            cards["Midas"] = "midas.png";
            cards["Nebuchadnezzar"] = "nebuchadnezzar.png";
            cards["Nefertiti"] = "nefertiti.png";
            cards["Nero"] = "nero.png";
            cards["Pericles"] = "pericles.png";
            cards["Phidias"] = "phidias.png";
            cards["Plato"] = "plato.png";
            cards["Praxiteles"] = "praxiteles.png";
            cards["Ptolemy"] = "ptolemy.png";
            cards["Pythagoras"] = "pythagoras.png";
            cards["Ramses"] = "ramses.png";
            cards["Sappho"] = "sappho.png";
            cards["Solomon"] = "solomon.png";
            cards["Varro"] = "varro.png";
            cards["Vitruvius"] = "vitruvius.png";
            cards["Xenophon"] = "xenophon.png";
            cards["Zenobia"] = "zenobia.png"; 
            cards["Gamers Guild"] = "gamersguild.png"; 
            cards["Diplomats Guild"] = "diplomatsguild.png"; 
            cards["Architects Guild"] = "architectsguild.png"; 
        }  
